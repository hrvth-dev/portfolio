...
function AboutMe() {
  ...
  return (
    <>
      <section className="h-screen flex flex-col justify-center items-center" ref={headerRef}>
        <h1
          className="text-center text-white mb-4 text-6xl animation1"
        >
          hrvth-dev
        </h1>
        <div className="flex justify-center items-center">
          <a
            ...
            className="text-white m-3 hover:scale-110 transition-transform"
          >
            <svg
